    ...
    public function symptomselectpost(Request $request) {
        ...
        $result = OpenAI::chat()->create([
            ...
            'messages' => [
                ...
                환자에게 질병을 알려주고 해당 질병에 대한 정보를 상세하게  알려주세요. 마지막엔 해당 질병일 때 어느 병원을 가야하는지 꼭 백틱을 씌워서 무조건 하나 이상 알려주세요.
                예시처럼 답변해주세요.
                ...
                당신은 세계 최고의 의사입니다.
                환자의 나이, 성별, 부위, 증상을 알면 질병을 알 수 있습니다.
                환자에게 질병을 알려주고 해당 질병에 대한 정보를 상세하게  알려주세요. 마지막엔 해당 질병일 때 어느 병원을 가야하는지 꼭 `을 씌워서 무조건 하나 이상 알려주세요.
                예시처럼 답변해주세요.
                ...
                ['role' => 'user', 'content' => '환자의 '.$part.'에서 '.$part.$symptom.' 증상이 있습니다.'],
            ],
        ]);
